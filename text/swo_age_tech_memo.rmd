...
## Analysis and Presentation of Input Sample Size
...
The strength of the relationship between $ISS$ and the number of sampled hauls, in terms of the $R^2$ value from a linear model fit, was stock and region-specific (Tables \@ref(tab:iss_hls_rsq_bs) and \@ref(tab:iss_hls_rsq_goai)).
