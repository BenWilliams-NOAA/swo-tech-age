...
Species within each survey that are assessed with statistical catch-at-age models (Tier $\geq$ 3 stock assessments, Table \@ref(tab:species)) were selected to be included in this analysis.
