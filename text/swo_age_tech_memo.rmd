...
[General para on age-structured assessments at AFSC]
Under the North Pacific Fishery Management Council (NPFMC) Fishery Management Plan (FMP) for the Eastern Bering Sea, Aleutian Islands, and Gulf of Alaska, Tier 1, 2, and 3 stocks use an age-structured assessment model to estimate population and management quantities (@ref).
...
The Alaska Fisheries Science Center (AFSC) operates fishery-independent surveys that then provide age and length composition data to ## stocks assessed with age-structured models.
...
[General para on weighting age and length comp data as it relates to input sample size]


[Purpose para: to generate age and length composition input sample sizes]
