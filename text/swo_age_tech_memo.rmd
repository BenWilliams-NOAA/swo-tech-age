...
Currently, no species age compositions in the EBS are estimated using stratified ALKs, rather, all observations are pooled for the entirety of the survey area each survey year. 
