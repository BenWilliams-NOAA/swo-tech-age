...
output:
  bookdown::word_document2:
    ...
    reference_docx: styles_reference_ph.docx
    pandoc_args:  
...
The bootstrap-simulation was developed in R [@Rcore] and is available via GitHub as an R package (<https://github.com/BenWilliams-NOAA/swo> *will need to change this to the surveyISS package, potentially having been moved to AFSC github*).
