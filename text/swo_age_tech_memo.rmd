...
Sub-regional ISS for age and length composition can also be estimated within the GOA survey, and is shown in Figures \@ref(fig:sublength-iss) - \@ref(fig:subage-iss).
...
It is unclear as to the consequence of ISS misspecification in AFSC assessments that use the number of sampled hauls as a proxy for ISS, as ISS misspecification can lead to bias model results [@Stewart2017; @Xu2020].
...
We thank *reviewers* for their helpful reviews of this manuscript.
