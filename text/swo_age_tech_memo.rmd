...
[General para on use of age and length comp data in AFSC assessments - Matt and Pete]

[General para on age & length sampling in AFSC bottom trawl surveys - Jason]

[General para on effective sample size and estimating input sample size - Matt and Pete]

[Objective para - Pete and Matt]
...
There are two stock complexes at AFSC in which the species are combined and assessed within the same statistical catch-at-age model: blackspotted and rougheye rockfish in the GOA and AI (*Spencer*, *Sullivan*).
